    ...
    <section id="lighthouse" className="bg-yellow-100">
      ...
      <section ref={textRef} className="pb-24 px-6 lg:px-24 ">
        <div className="max-w-screen-2xl mx-auto text-center">
          ...
          >
            I graduated from Lighthouse Labs' intensive diploma program, where I
            honed my skills in front-end and back-end development, database
            management, Git version control, and Agile methodologies. I gained
            proficiencies and valuable knowledge in HTML, CSS, JavaScript,
            Node.js, Express.js, SQL, Ruby, and React/Next.js, I specialized in
            creating dynamic, high-performance web applications and had a strong
            emphasis on collaboration, code reviews, and industry best
            practices.
          </p>
        </div>
      </section>
